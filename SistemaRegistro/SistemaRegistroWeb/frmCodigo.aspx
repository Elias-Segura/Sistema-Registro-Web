<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCodigo.aspx.cs" Inherits="SistemaRegistroWeb.frmCodigo" %>
  ...
  <div>
        ...
        <form id="form1" runat="server">
          ...
          <div   id="formulario" runat="server"  class="center" >
                        ...
                        <h1 id="title">Código</h1>   
                         <div class="form-group">
                            <label >Organización:</label>
                             <asp:DropDownList ID="DrpOrganizacion" runat="server" CssClass="form-control"></asp:DropDownList>
                         </div>

                          <div class="form-group">
                            <label>Código: </label>
                            <input type="text" class="form-control" id="txtCodigo" placeholder="Ciclo" runat="server" />
                          </div>
        ...
        <div>
           <asp:GridView ID="dgCodigo" runat="server" GridLines="None"
                ...
                PageSize="7" AutoGenerateColumns="False" DataKeyNames="Codigo_id"  OnRowCommand="dgCodigo_RowCommand" OnRowDeleting="dgCodigo_RowDeleting" OnPageIndexChanging="dgCodigo_PageIndexChanging">
                <Columns>
                 
                   
                    <asp:BoundField DataField="Organizacion_nombre" HeaderText="Organización" />
                    <asp:BoundField DataField="Codigo_formato" HeaderText="Formato" />
            
                     <asp:TemplateField>
                        <ItemTemplate>
                           
                            <asp:Button Text="" runat="server" CommandName="Editar" CommandArgument='<%# Eval("Codigo_id") %>'  CssClass="bgimg"  Width="30px" Height="30px" BorderStyle="None" />
